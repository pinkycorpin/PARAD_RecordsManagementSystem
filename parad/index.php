	      		...
	      		<div class="border" style="box-shadow:0px 1px 2px 0px rgba(0,0,0,0.5);width:400px;height:540px;background-color:white;">
	        		...
	        		<legend>Login</legend><br>
	        		 <form class="form-group" action="include/login.inc.php" method="POST"> 
	          			<label class="form-group" style="font-size:14px;margin-left:-5%;">Username &nbsp&nbsp</label><input class="form-group" type="text"  class="form-control"  name="username" required="required"/><br>
	           			<label class="form-group" style="font-size:14px;margin-left:-5%;" >Password &nbsp&nbsp</label><input class="form-group" type="password"  class="form-control" name="password" required="required"/></label><br>
